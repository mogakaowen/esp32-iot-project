...
$servername = "localhost";  //add your servername here
$dBUsername = "id19262938_kiprop"; //add your username here
$dBPassword = "K>Q5IQD1hxDe+7eh"; // add the password here
$dBName = "id19262938_esptrial"; // add the database name here
